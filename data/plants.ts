...
export const plants: Plant[] = [
  ...
  },
  {
    slug: "mazzard-cherry",
    name: "Mazzard Cherry",
    scientificName: "Prunus avium (wild form)",
    tagline: "The wild sweet cherry. Standard rootstock for grafted cherries worldwide.",
    description: "Mazzard is the wild form of the sweet cherry — the species that all commercial sweet cherry varieties are grafted onto. It produces small, dark, intensely flavored cherries on a large vigorous tree. Grown on its own roots it becomes a substantial specimen — 30–40 feet, good fall color, showy white spring bloom. As a rootstock it imparts vigor and longevity to grafted varieties. Zone 4–8. The backbone of every cherry orchard that has ever existed, and an excellent tree in its own right.",
    zoneMin: 4, zoneMax: 8,
  ...
  },
  {
    ...
    tagline: "St. Lucie cherry. Drought-tolerant rootstock. Small black fruits. Tough as stone.",
    description: "Mahaleb — the St. Lucie cherry — is the drought-tolerant rootstock used for cherries in dry, alkaline, or rocky soils where Mazzard struggles. Native to southern Europe and western Asia, it handles limestone, clay, and dry summers that would stress most Prunus. Produces masses of small, intensely aromatic black cherries. The seeds and wood have a distinctive coumarin fragrance — used historically in perfumery and pipe tobacco. Zone 5–8. Underplanted in yards, underused as a rootstock in the American South. Indispensable if you're serious about cherries in hard conditions.",
    zoneMin: 5, zoneMax: 8,
